...
sortHTMLTable.prototype = {
	...
	initialize: function( tableId, options ) {
		...
		this.options = {
            reorderCol: false,
			pathToImgUp: '../media/files/perso/fleche_haut.png',
			pathToImgDown: '../media/files/perso/fleche_bas.png',
			pathToImgUpActive: '../media/files/perso/fleche_haut_active.png', 
			pathToImgDownActive: '../media/files/perso/fleche_bas_active.png'
		}.extend( options || {} );
