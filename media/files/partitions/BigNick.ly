...
\header {
  ...
  url = #"https://www.youtube.com/watch?v=2r6ust9UrkY"
...
\repeat volta 2 {
  r8 cis d es e f fis d'! | b4-. r8 g e?-. a fis4-. |
  r8 cis d es e4. d'!8 | b8-. fis e4-. r8 a \tuplet 3/2 { e c? e } | \break
  d4-. r8 d a'4-. r8 g | d'16 e d c g'4~ g4. g,8 | 
  e'4-. r8 d, d'4-. r8 d,|
 b'4. \startTrillSpan a8 \stopTrillSpan e16 f e c fis4-. \break }

\tuplet 3/2 { a16 bes as } g8~ g2.~ | g1 \bar ".."
}
...
grilleB = \chordmode {
  ...
  \/ d:6 b:7 \s a:m7 d:7 \break 
  \bar ":|]" 
   s1 \bar "" s \stopStaff
  
  d1:6   a \startStaff
   \bar "||" \break
   \/ g2:m7 a:9- \/ d2:m d:9- \/ g:7 f:7 \/ es:7 d:9- \break
   \/ g:m7 a:9- \/ d2:m d:9- \/ g:7 f:7 \/ es:7 d:9-  \break
   \/ d2:6 g:7 \/ d2:6 g:7 \/ d2:6 a:7 \/ d2:6 fis:dim7 \startStaff \break
  g1:m7 \/ e2:m5-7 a:5+7 \startStaff  d1:6  \/ a2:m7 d:7
...
\book {
  ...
  \bookpart {
   ...
   \markup \bold \fontsize #2 \with-color #red "Les 2 dernières mesures ne sont pas jouées lors des solos"
} }
